...
# Simplified Workload Identity Federation setup based on latest Google Cloud docs
# This uses the current recommended approach for GitHub Actions
...
# Create workload identity provider using recommended settings
